...
const results = 
[
	new Result("Сорян, нет правильных", 0),
	new Result("Скопируй промо-код на скидку 3% при заказе наших наушников на маркетплейсе", 3),
	new Result("Скопируй промо-код на скидку 5% при заказе наших наушников на маркетплейсе", 5),
	new Result("Скопируй промо-код на скидку 10% при заказе наших наушников на маркетплейсеу", 10)
];
...
function Update()
{
	...
	else
	{
		...
		pagesElem.innerHTML = "Ого, " + quiz.score + " из 10";
	}
}
